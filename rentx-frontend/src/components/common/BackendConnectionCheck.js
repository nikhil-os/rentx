  ...
  useEffect(() => {
    ...
    const checkBackendConnection = async () => {
      try {
        ...
        // Old URL: await fetch('http://localhost:5000', { 
        await fetch(baseUrl, { 
          method: 'GET',
    ...
    <div className="bg-red-100 text-red-800 px-4 py-3 fixed bottom-0 left-0 right-0 z-50 shadow-lg">
      <div className="container mx-auto flex items-center justify-between">
        <div className="flex items-center">
          ...
          {/* <span className="font-medium">Backend connection error: The server at http://localhost:5000 is not reachable.</span> */}
          <span className="font-medium">Backend connection error: The server at {backendUrl} is not reachable.</span>
        </div>
        <a 
          href="#" 
